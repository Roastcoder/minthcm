...
use mehar finance\Api\Entities\Comments;
use Slim\Psr7\Response;
use Psr\Http\Message\ServerRequestInterface as Request;
use mehar finance\Modules\Comments\AccessChecker;
...
class CommentsController
{
    ...
    {
        $class_path = "\mehar finance\Modules\Comments\AccessChecker\\{$parent->module_name}AccessChecker";
