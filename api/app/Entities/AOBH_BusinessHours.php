...
/**
 * @ORM\Entity
 * @ORM\Table(name="aobh_businesshours", indexes={
 * @ORM\Index(name="aobh_businesshourspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $closing_hours
 * @property mixed $open_status
 * @property mixed $day
 */
// Auto-generated SectionRepository section end
class AOBH_BusinessHours extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aobh_businesshours")
     */
