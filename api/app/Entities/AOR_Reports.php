...
/**
 * @ORM\Entity
 * @ORM\Table(name="aor_reports", indexes={
 * @ORM\Index(name="aor_reportspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $graphs_per_row
 */
// Auto-generated SectionRepository section end
class AOR_Reports extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aor_reports")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=AOR_Fields::class, mappedBy="aor_reports")
     */
    protected Collection $aor_fields;

    /**
     * @ORM\OneToMany(targetEntity=AOR_Conditions::class, mappedBy="aor_reports")
     */
    protected Collection $aor_conditions;

    /**
     * @ORM\OneToMany(targetEntity=AOR_Scheduled_Reports::class, mappedBy="aor_report")
     */
    protected Collection $aor_scheduled_reports;

    /**
     * @ORM\OneToMany(targetEntity=AOR_Charts::class, mappedBy="aor_report")
     */
    protected Collection $aor_charts;
    ...
    public function __construct()
    {
        ...
        $this->aor_fields = new ArrayCollection();
        $this->aor_conditions = new ArrayCollection();
        $this->aor_scheduled_reports = new ArrayCollection();
        $this->aor_charts = new ArrayCollection();
    }
