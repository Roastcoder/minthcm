...
/**
 * @ORM\Entity
 * @ORM\Table(name="fp_events", indexes={
 * @ORM\Index(name="fp_eventspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $invite_templates
 * @property mixed $accept_redirect
 * @property mixed $decline_redirect
 * @property mixed $activity_status_type
 */
// Auto-generated SectionRepository section end
class FP_events extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="fp_events")
     */
    ...
    /**
     * @ORM\JoinTable(name="fp_event_locations_fp_events_1_c", joinColumns={@ORM\JoinColumn(name="fp_event_locations_fp_events_1fp_events_idb", referencedColumnName="id")}, inverseJoinColumns={@ORM\JoinColumn(name="fp_event_locations_fp_events_1fp_event_locations_ida", referencedColumnName="id")})
     * @ORM\ManyToMany(targetEntity=FP_Event_Locations::class, inversedBy="fp_event_locations_fp_events_1")
     */
    protected Collection $fp_event_locations_fp_events_1;
    ...
    public function __construct()
    {
        ...
        $this->fp_event_locations_fp_events_1 = new ArrayCollection();
    }
