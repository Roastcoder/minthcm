...
/**
 * @ORM\Entity
 * @ORM\Table(name="aod_index", indexes={
 * @ORM\Index(name="aod_indexpk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $last_optimised
 * @property mixed $location
 */
// Auto-generated SectionRepository section end
class AOD_Index extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aod_index")
     */
