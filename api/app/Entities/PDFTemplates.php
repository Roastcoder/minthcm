...
/**
 * @ORM\Entity
 * @ORM\Table(name="pdftemplates", indexes={
 * @ORM\Index(name="pdftemplatespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $relatedmodule
 * @property mixed $type
 * @property mixed $orientation
 * @property mixed $preview
 */
// Auto-generated SectionRepository section end
class PDFTemplates extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="pdftemplates")
     */
