...
/**
 * @ORM\Entity
 * @ORM\Table(name="aok_knowledgebase", indexes={
 * @ORM\Index(name="aok_knowledgebasepk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $user_id_c
 * @property mixed $user_id1_c
 */
// Auto-generated SectionRepository section end
class AOK_KnowledgeBase extends MintEntity
{
     ...
     * @ORM\Column(type="id", length="36")
     */
    protected $user_id1_c;

    /**
     * @ORM\JoinColumn(name="modified_user_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aok_knowledgebase")
     */
    ...
    /**
     * @ORM\JoinTable(name="aok_knowledgebase_categories")
     * @ORM\ManyToMany(targetEntity=AOK_Knowledge_Base_Categories::class, mappedBy="aok_knowledgebase_categories")
     */
