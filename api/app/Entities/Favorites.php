...
/**
 * @ORM\Entity
 * @ORM\Table(name="favorites", indexes={
 * @ORM\Index(name="favoritespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class Favorites extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="favorites")
     */
