...
/**
 * @ORM\Entity
 * @ORM\Table(name="oauth2tokens", indexes={
 * @ORM\Index(name="oauth2tokenspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $token_is_revoked
 * @property mixed $token_type
 * @property mixed $access_token_expires
 * @property mixed $access_token
 * @property mixed $refresh_token
 * @property mixed $refresh_token_expires
 * @property mixed $grant_type
...
class OAuth2Tokens extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="oauth2tokens")
     */
     ...
     * @ORM\ManyToOne(targetEntity=OAuth2Clients::class, inversedBy="oauth2tokens")
     */
    protected $oauth2clients;
