 ...
 * @ORM\Index(name="dictionariespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $list_module
 */
// Auto-generated SectionRepository section end
class Dictionaries extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="dictionaries")
     */
