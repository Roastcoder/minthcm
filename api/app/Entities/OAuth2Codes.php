...
/**
 * @ORM\Entity
 * @ORM\Table(name="oauth2codes", indexes={
 * @ORM\Index(name="oauth2codespk", columns={"id"}), 
 * @ORM\Index(name="idx_oauth2codes_code", columns={"code"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $code_expires
 * @property mixed $used
 */
// Auto-generated SectionRepository section end
class OAuth2Codes extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="oauth2codes")
     */
