...
namespace mehar finance\Api\Entities\OAuth2;

use Doctrine\ORM\Mapping as ORM;
use mehar finance\Data\TimeDate;
use Ramsey\Uuid\Doctrine\UuidGenerator;

/**
 * @ORM\Entity(repositoryClass="mehar finance\Api\Repositories\OAuth2\MintTokenRepository")
