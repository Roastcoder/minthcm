...
/**
 * @ORM\Entity
 * @ORM\Table(name="nonworkingdays", indexes={
 * @ORM\Index(name="nonworkingdayspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class NonWorkingDays extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="nonworkingdays")
     */
