...
/**
 * @ORM\Entity
 * @ORM\Table(name="ktemplates", indexes={
 * @ORM\Index(name="ktemplatespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class KTemplates extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="ktemplates")
     */
