...
/**
 * @ORM\Entity
 * @ORM\Table(name="aod_indexevent", indexes={
 * @ORM\Index(name="aod_indexeventpk", columns={"id"}), 
 * @ORM\Index(name="idx_record_module", columns={"record_module"}), 
 * @ORM\Index(name="idx_record_id", columns={"record_id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $record_module
 */
// Auto-generated SectionRepository section end
class AOD_IndexEvent extends MintEntity
{
     ...
     * @ORM\Column(type="string", length="255")
     */
    protected $record_module;

    /**
     * @ORM\JoinColumn(name="modified_user_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aod_indexevent")
     */
