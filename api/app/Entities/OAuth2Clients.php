...
/**
 * @ORM\Entity
 * @ORM\Table(name="oauth2clients", indexes={
 * @ORM\Index(name="oauth2clientspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $allowed_grant_type
 * @property mixed $duration_value
 * @property mixed $duration_amount
 * @property mixed $duration_unit
 * @property mixed $assigned_user_id
 */
// Auto-generated SectionRepository section end
class OAuth2Clients extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="oauth2clients")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=OAuth2Tokens::class, mappedBy="oauth2clients")
     */
    protected Collection $oauth2tokens;
    ...
    {
        $this->oauth2tokens = new ArrayCollection();
    }
