...
/**
 * @ORM\Entity
 * @ORM\Table(name="templatesectionline", indexes={
 * @ORM\Index(name="templatesectionlinepk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class TemplateSectionLine extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="templatesectionline")
     */
