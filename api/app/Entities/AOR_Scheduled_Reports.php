...
/**
 * @ORM\Entity
 * @ORM\Table(name="aor_scheduled_reports", indexes={
 * @ORM\Index(name="aor_scheduled_reportspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $last_run
 * @property mixed $status
 * @property mixed $email_recipients
 * @property mixed $aor_report_id
 */
// Auto-generated SectionRepository section end
class AOR_Scheduled_Reports extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aor_scheduled_reports")
     */
     ...
     * @ORM\ManyToOne(targetEntity=AOR_Reports::class, inversedBy="aor_scheduled_reports")
     */
    protected $aor_report;
