...
/**
 * @ORM\Entity
 * @ORM\Table(name="aos_pdf_templates", indexes={
 * @ORM\Index(name="aos_pdf_templatespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $type
 * @property mixed $pdfheader
 * @property mixed $pdffooter
 * @property mixed $margin_left
 * @property mixed $margin_right
 * @property mixed $margin_top
 * @property mixed $margin_bottom
 * @property mixed $margin_header
 * @property mixed $margin_footer
 * @property mixed $page_size
 * @property mixed $orientation
 */
// Auto-generated SectionRepository section end
class AOS_PDF_Templates extends MintEntity
{
     ...
     * @ORM\Column(type="integer", length="255")
     */
    protected $margin_header;

    /**
     * @ORM\Column(type="integer", length="255")
     */
    protected $margin_footer;
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aos_pdf_templates")
     */
