...
/**
 * @ORM\Entity
 * @ORM\Table(name="workingmonths", indexes={
 * @ORM\Index(name="workingmonthspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class WorkingMonths extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="workingmonths")
     */
