...
/**
 * @ORM\Entity
 * @ORM\Table(name="external_oauth_connections", indexes={
 * @ORM\Index(name="externaloauthconnectionpk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $external_oauth_provider_id
 */
// Auto-generated SectionRepository section end
class ExternalOAuthConnection extends MintEntity
{
     ...
     * @ORM\Column(type="id", length="36")
     */
    protected $external_oauth_provider_id;

    /**
     * @ORM\JoinColumn(name="modified_user_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="external_oauth_connections")
     */
    ...
    /**
     * @ORM\JoinColumn(name="external_oauth_provider_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=ExternalOAuthProvider::class, inversedBy="external_oauth_connections")
     */
    protected $external_oauth_provider;
