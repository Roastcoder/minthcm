...
/**
 * @ORM\Entity
 * @ORM\Table(name="fp_event_locations", indexes={
 * @ORM\Index(name="fp_event_locationspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $address_country
 * @property mixed $address_postalcode
 * @property mixed $address_state
 * @property mixed $capacity
 */
// Auto-generated SectionRepository section end
class FP_Event_Locations extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="fp_event_locations")
     */
    ...
    /**
     * @ORM\JoinTable(name="fp_event_locations_fp_events_1_c")
     * @ORM\ManyToMany(targetEntity=FP_events::class, mappedBy="fp_event_locations_fp_events_1")
     */
