...
/**
 * @ORM\Entity
 * @ORM\Table(name="aor_charts", indexes={
 * @ORM\Index(name="aor_chartspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $type
 * @property mixed $x_field
 * @property mixed $y_field
 */
// Auto-generated SectionRepository section end
class AOR_Charts extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="aor_charts")
     */
     ...
     * @ORM\ManyToOne(targetEntity=AOR_Reports::class, inversedBy="aor_charts")
     */
