...
$mod_strings = array(
    ...
    'LBL_SYNCED_RECURRING_MSG' => 'This call originated in another system and was synced to mehar finance. To make changes, go to the original call within the other system. Changes made in the other system can be synced to this record.',
    // for reminders
    ...
    'LBL_SUBJECT_COMMENT' => 'Brief description of the call.',
    'LBL_DURATION_HOURS_COMMENT' => 'Call duration, hours portion.',
    'LBL_DURATION_MINUTES_COMMENT' => 'Call duration, minutes portion.',
    'LBL_DATE_COMMENT' => 'Date when the call is scheduled to start or actually started.',
    'LBL_DATE_END_COMMENT' => 'Date when the call is scheduled to end or actually ended.',
    'LBL_PARENT_TYPE_COMMENT' => 'The Sugar object to which the call is related.',
    'LBL_PARENT_NAME_COMMENT' => 'Name of the record this call is related to.',
    'LBL_STATUS_COMMENT' => 'The status of the call (Held, Not Held, etc.).',
    'LBL_DIRECTION_COMMENT' => 'Indicates whether the call is inbound or outbound.',
    'LBL_LIST_RELATED_TO_ID_COMMENT' => 'The ID of the parent Sugar object identified by parent_type.',
    ...
    'LBL_OUTLOOK_ID_COMMENT' => 'When the Sugar Plug-in for Microsoft Outlook syncs an Outlook appointment, this is the Outlook appointment item ID.',
    'LBL_ACCEPT_STATUS_COMMENT' => 'Acceptance status of the call invitation.',
    'LBL_ACCEPT_LINK_COMMENT' => 'Link to accept the call invitation.',
    ...
    'LBL_RECURRING_SOURCE_COMMENT' => 'Source of recurring call.',
    'LBL_RESCHEDULE_HISTORY_COMMENT' => 'History of reschedules for this call.',
    'LBL_RESCHEDULE_COUNT_COMMENT' => 'Number of times the call has been rescheduled.',
);
