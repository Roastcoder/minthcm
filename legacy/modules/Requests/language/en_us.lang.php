...
$mod_strings = array(
   ...
   'LNK_LIST' => 'View Requests',
   'LBL_RELATIONSHIP_TRAININGS_NAME' => 'Trainings',
   'LBL_LIST_FORM_TITLE' => 'Requests',
   ...
   'LBL_TYPE' => 'Type',
   'LBL_ASSIGNED_TO_ID' => 'Applicant (ID)',
   'LBL_ASSIGNED_TO_NAME' => 'Applicant',
   'LBL_EMPLOYEE' => 'Decision Maker',
   'LBL_TRAINING' => 'Training',
   'LBL_TRAINING_ID' => 'Training (ID)',
   'LBL_TRAINING_NAME' => 'Training',
   'LBL_BENEFIT' => 'Benefit',
   'LBL_BENEFIT_ID' => 'Benefit (ID)',
   'LBL_BENEFIT_NAME' => 'Benefit',
);
