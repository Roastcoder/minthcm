...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => 'Use <b>mehar finance Portal Editor</b> to manage and customize the mehar finance Portal.',
            ...
            'portalBtn' => 'Customize the module <b>Layouts</b> that appear in the <b>mehar finance Portal</b>.',
            ...
            'viewBtnDashlet' => 'Customize the module\'s <b>mehar finance Dashlet</b>, including the mehar finance Dashlet\'s ListView and Search.<br><br>The mehar finance Dashlet will be available to add to the pages in the Home module.',
            ...
            'dashletHelp' => 'The <b>mehar finance Dashlet</b> layouts that can be customized appear here.<br><br>The mehar finance Dashlet will be available to add to the pages in the Home module.',
            'DashletListViewBtn' => 'The <b>mehar finance Dashlet ListView</b> displays records based on the mehar finance Dashlet search filters.',
            'DashletSearchViewBtn' => 'The <b>mehar finance Dashlet Search</b> filters records for the mehar finance Dashlet listview.',
            ...
            'portalHelp' => 'Manage and customize the <b>mehar finance Portal</b>.',
            'SPUploadCSS' => 'Upload a <b>Style Sheet</b> for the mehar finance Portal.',
            'SPSync' => '<b>Sync</b> customizations to the mehar finance Portal instance.',
            'Layouts' => 'Customize the <b>Layouts</b> of the mehar finance Portal modules.',
            'portalLayoutHelp' => 'The modules within the mehar finance Portal appear in this area.<br><br>Select a module to edit the <b>Layouts</b>.',
        ...
        'portalSync' => array(
            'default' => 'Enter the <b>mehar finance Portal URL</b> of the portal instance to update, and click <b>Go</b>.<br><br>Then enter a valid mehar finance user name and password, and then click <b>Begin Sync</b>.<br><br>The customizations made to the mehar finance Portal <b>Layouts</b>, along with the <b>Style Sheet</b> if one was uploaded, will be transferred to specified the portal instance.',
        ),
        'portalStyle' => array(
            'default' => 'You can customize the look of the mehar finance Portal by using a style sheet.<br><br>Select a <b>Style Sheet</b> to upload.<br><br>The style sheet will be implemented in the mehar finance Portal the next time a sync is performed.',
        ),
    ),
    ...
    'assistantHelp' => array(
        'package' => array(
            ...
            'afterSave' => 'Your new package should contain at least one module. You can create one or more custom modules for the package.<br/><br/>Click <b>New Module</b> to create a custom module for this package.<br/><br/> After creating at least one module, you can publish or deploy the package to make it available for your instance and/or other users\' instances.<br/><br/> To deploy the package in one step within your mehar finance instance, click <b>Deploy</b>.<br><br>Click <b>Publish</b> to save the package as a .zip file. After the .zip file is saved to your system, use the <b>Module Loader</b> to upload and install the package within your mehar finance instance. <br/><br/>You can distribute the file to other users to upload and install within their own mehar finance instances.',
        ...
        'module' => array(
            'somemodules' => "Since the current package contains at least one module, you can <b>Deploy</b> the modules in the package within your mehar finance instance or <b>Publish</b> the package to be installed in the current mehar finance instance or another instance using the <b>Module Loader</b>.<br/><br/>To install the package directly within your mehar finance instance, click <b>Deploy</b>.<br><br>To create a .zip file for the package that can be loaded and installed within the current mehar finance instance and other instances using the <b>Module Loader</b>, click <b>Publish</b>.<br/><br/> You can build the modules for this package in stages, and publish or deploy when you are ready to do so. <br/><br/>After publishing or deploying a package, you can make changes to the package properties and customize the modules further. Then re-publish or re-deploy the package to apply the changes.",
...
//STUDIO2
    ...
    'LBL_SUITEPORTAL' => 'mehar finance Portal Editor',
    ...
    'LBL_DASHLET' => 'mehar finance Dashlet',
    'LBL_DASHLETLISTVIEW' => 'mehar finance Dashlet ListView',
    'LBL_POPUP' => 'Popup View',
    'LBL_POPUPLISTVIEW' => 'Popup ListView',
    'LBL_POPUPSEARCH' => 'Popup Search',
    'LBL_DASHLETSEARCHVIEW' => 'mehar finance Dashlet Search',
