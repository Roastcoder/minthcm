...
$mod_strings = array(
   ...
   'ERR_CREDENTIALS_MISSING' => 'Your mehar finance credentials are missing.',
   ...
   'HDR_LOGIN_PANEL' => 'Please enter your mehar finance Login credentials.',
   'HEARTBEAT_MESSAGE' => "<BR>The mehar finance Updates mechanism allows your server to check to see if an update for your version of mehar finance is available.",
   ...
   'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by mehar finance',
   ...
   'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the mehar finance application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
   'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your mehar finance application files in a .zip file, enter the following information:',
   'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
   'LBL_BACKUPS_TITLE' => 'Backups',
   'LBL_BACKUPS' => 'Backup mehar finance files',
   ...
   'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the mehar finance Server.
   ...
   'LBL_DIAGNOSTIC_CONFIGPHP' => 'mehar finance config.php',
   'LBL_DIAGNOSTIC_CUSTOMDIR' => 'mehar finance Custom directory',
   ...
   'LBL_DIAGNOSTIC_GETSUITELOG' => 'Getting mehar finance.log',
   ...
   'LBL_DIAGNOSTIC_SUITELOG' => 'mehar finance Log File',
   'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
   'LBL_DIAGNOSTIC_VARDEFS' => 'mehar finance schema output (VARDEFS)',
   ...
   'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the mehar finance Password Management feature settings will apply.',
   ...
   'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=mehar finance',
   ...
   'LBL_MI_IN_DASHLETS' => 'Installing mehar finance Dashlet ',
   'LBL_MI_UN_DASHLETS' => 'Uninstalling mehar finance Dashlet ',
   ...
   'LBL_MODULE_LOADER' => 'Add or remove mehar finance modules, themes, language packs and other extensions',
   ...
   'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as mehar finance updates.',
   ...
   'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the mehar finance Dashlets cache file',
   'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'mehar finance Dashlets cache file rebuilt.',
   'LBL_REBUILD_DASHLETS_DESC' => 'Removing mehar finance Dashlets cache and scanning known directories for mehar finance Dashlet files.',
   'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild mehar finance Dashlets',
   ...
   'LBL_RETURN' => 'Return',
   'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to mehar finance. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
   ...
   'LBL_SUITE_UPDATE_TITLE' => 'mehar finance Updates',
   ...
   'LBL_UPDATE_TITLE' => 'mehar finance Updates',
   'LBL_UPGRADE_TITLE' => 'Repair',
   'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
   'LBL_UPGRADE_WIZARD' => 'Upload and install mehar finance upgrades',
   'LBL_UPGRADE' => 'Check and repair mehar finance',
   ...
   'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in mehar finance.',
   ...
   'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of mehar finance',
   'LBL_SUITEPORTAL' => 'mehar finance Portal',
   ...
   'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, mehar finance Dashlets etc.',
   ...
   'LBL_QR_CBOX_CLEARDASHLET' => 'Clear mehar finance Dashlet Cache Data',
   ...
   'LBL_QR_CLEARDASHLET' => 'Clearing mehar finance Dashlet files from cache...done',
   ...
   'LBL_QR_CBOX_CLEARSUITEFEEDCACHE' => 'Clear mehar finance Feed Cache',
   'LBL_QR_CLEARSUITEFEEDCACHE' => 'Clearing mehar finance Feed Cache...done',
   ...
   'ML_RELAX_LOCAL' => 'If you are running mehar finance locally, you can relax your Module Loader restrictions to allow the package to be installed.',
   'ML_SUITE_KB' => 'mehar finance Knowledge Base',
   'ML_SUITE_DZ' => 'mehar finance Developer Zone',
   'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
   'ML_OVERRIDE_CORE_FILES' => 'Overriding of core mehar finance files is not allowed ',
   ...
   'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the mehar finance Password Management feature settings will apply.',
   ...
   'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Elasticsearch requires an external server set up to work. Read the <a href="https://meharadvisory.com/documentation/">documentation</a> to learn how.',
