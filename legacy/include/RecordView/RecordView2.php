 ...
 * @api
 */
class RecordView2 extends EditView
{
    /**
     * @var string $view
     */
     ...
     * This is the RecordView constructor responsible for processing the new
     * Meta-Data framework
     *
     * @param string $module String value of module this record view is for
     ...
     * @param string $metadataFileName specifies the name of the metadata file eg 'recordviewdefs'
     */
    public function setup(
        $module,
        $focus  = null,
        $metadataFile = null,
        $tpl = 'include/RecordView/RecordView.tpl',
        $createFocus = true,
        $metadataFileName = 'recordviewdefs'
        )
    {
        global $sugar_config;
        ...
        if(!empty($this->metadataFile) && file_exists($this->metadataFile)){
        	...
        	if(!file_exists("modules/$this->module/metadata/$metadataFileName.php") &&
        	    file_exists("modules/$this->module/RecordView.html")) {
                global $dictionary;
        	    $htmlFile = "modules/" . $this->module . "/RecordView.html";
