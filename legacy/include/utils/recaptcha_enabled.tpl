...
{literal}
    ...
    /**
     * Callback to handle when mehar finance has responded to the browser
    ...
    /**
     * Send recaptcha response to mehar finance with the user's details from the login screen
    ...
    /**
     * Send recaptcha response to mehar finance with the user's details from the change password screen
     * @return {boolean}
     */
