 ...
 */
require_once('include/RecordView/RecordView2.php');
 ...
 * @category Views
 */
class ViewRecord extends SugarView {
   ...
   public function preDisplay() {
      ...
      $this->rv = new RecordView2();
      $this->rv->ss = & $this->ss;
      $this->rv->setup($this->module, $this->bean, $metadataFile, get_custom_file_if_exists('include/DetailView/DetailView.tpl'));
   }
