...
<a href="index.php?entryPoint=download&id={$fields.{{$vardef.fileId}}.value}&type={{$vardef.linkModule}}&date={$fields.date_modified.value}" class="tabDetailViewDFLink" target='_blank'>{{sugarvar key='value'}}</a>
&nbsp;
{if !empty($parentFieldArray.filename.value)}
<a href="index.php?preview=yes&entryPoint=download&id={$fields.{{$vardef.fileId}}.value}&type={{$vardef.linkModule}}&date={$fields.date_modified.value}" class="tabDetailViewDFLink" target='_blank' style="border-bottom: 0px;">
