...
<div class="p_login">
    ...
    <div class="p_login_left">
        <div class="info-content">
            <div class="companylogo">{$LOGIN_IMAGE}</div>
            <h1>mehar finance</h1>
            <p>Advanced Human Capital Management Solution</p>
        ...
        <div class="p_login_middle">
            ...
            <div id="loginform">
                <form class="form-signin" role="form" action="index.php" method="post" name="DetailView" id="form"
                    ...
                    <h2 class="form-signin-heading">{sugar_translate module="Users" label="LBL_LOGIN_TITLE"}</h2>
            ...
            <div class="p_login_bottom">
                <a id="admin_options">&copy; mehar finance</a>
            </div>
        </div>
    </div>
